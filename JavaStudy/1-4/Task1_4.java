...
public class Task1_4 {
    ...
    private static final String ACCOUNT_NAME = "alice";
    private static final String ACCOUNT_PASS = "pass";
    // 定数（メッセージ）
    ...
    public static void main(String[] args) {
        ...
        if(ACCOUNT_NAME.equals(name) && ACCOUNT_PASS.equals(pass)){
          System.out.println(CONST_MSG_SUCCESS);
        }

        // ③ 名前のみ正しい場合、「 パスワードに誤りがあります。 」と出力してください。
        else if(ACCOUNT_NAME.equals(name)){
          System.out.println(CONST_MSG_ERROR_PASS);
        }

        // ④ パスワードのみ正しい場合、「 名前に誤りがあります。 」と出力してください。
        else if(ACCOUNT_PASS.equals(pass)){
