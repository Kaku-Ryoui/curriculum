...
public class ExException {
            ...
            try {
                ...
                switch (parameter) {
                    ...
                    case CONST_EXCEPTION_TRIGER_ARRAY_OUT_OF_BOUNDS:
                        // 問②:
                        // 「throw」を使用せずに「ArrayIndexOutOfBoundsException」を発生させる処理を記述しなさい。
    ...
    /**
     * 問①: 以下のルールに沿ってNullPointerExceptionを投げるメソッドを実装しなさい。 ルール1: private static
     * void 任意のメソッド名 throws 上位へ投げるExceptionクラス名 { NullPointerExceptionを発生させる処理 }
     * ルール2: 例外発生時に設定するメッセージは、定義済みの定数から適当なものを指定してください。
     */
    private static void printNullEx() throws NullPointerException {
